...
public class CartVO {
	...
	public String toString() {
		return "CartVO [cartId=" + cartId + ", name=" + name + ", shippingDate=" + shippingDate + ", addressName="
				+ addressName + ", addressDetail=" + addressDetail + ", registDt=" + registDt + ", country=" + country
				+ ", zipCode=" + zipCode + ", cartDetVOList=" + cartDetVOList + "]";
	}
}
