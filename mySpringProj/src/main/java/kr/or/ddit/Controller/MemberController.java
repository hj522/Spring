...
//   요청파라미터 : {"userId" : "hongkd", "passwd" : "1234", "coin":"100"}
   ...
   /*
	...
	폼 필드 값이 숫자일 경우, 컨트롤러 타입을 숫자형으로 작성하여 숫자로 타입변환 후	(int coin)
	요청 데이터를 취득할 수 있음
    */
   ...
   // 골뱅이RequestParam 애너테이션을 사용하여 HTML 폼 필드명을 지정하여 요청을 처리할 수 있음
   ...
   public String register05ByBeansPost(@ModelAttribute MemberVO memberVO, int coin, ArrayList<String> cars, AddressVO addressVO, Model model) {
	   ...
	   // 보유 자동차(String[] cars) -> 보유 자동차(String car)
   ...
   // 요청URI : /registerByGet01?userId=a001&birth=1234 (실패)
   // 요청URI : /registerByGet01?userId=a001&birth=2022-10-31 (실패)
   // 요청URI : /registerByGet01?userId=a001&birth=20221031 (실패)
   // 요청URI : /registerByGet01?userId=a001&birth=2022/10/31 (OK)
   ...
   // 요청URI : /registerByGet02?userId=a001&birth=1234 (실패)
   // 요청URI : /registerByGet02?userId=a001&birth=2022-10-31 (실패)
   // 요청URI : /registerByGet02?userId=a001&birth=20221031 (실패)
   // 요청URI : /registerByGet02?userId=a001&birth=2022/10/31 (OK)
